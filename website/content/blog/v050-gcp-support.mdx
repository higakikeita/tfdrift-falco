...
# 🚀 driftwire v0.5.0: Multi-Cloud Arrives

**Release Date**: January 10, 2026

**Major milestone**: driftwire scales beyond AWS to support Google Cloud Platform (GCP) with comprehensive audit log integration.

## 🎯 Multi-Cloud Vision

v0.5.0 brings driftwire to the next level:
...
**driftwire v0.5.0** - Multi-Cloud Drift Detection for AWS & GCP
