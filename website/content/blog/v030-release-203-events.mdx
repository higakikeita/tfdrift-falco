---
title: "driftwire v0.3.0 Released: 203 CloudTrail Events Across 19 AWS Services"
date: "2025-12-14"
...
# driftwire v0.3.0 Released: 203 CloudTrail Events Across 19 AWS Services

We're thrilled to announce the **official release of driftwire v0.3.0**! This major milestone delivers comprehensive AWS infrastructure drift detection, achieving **103% of our target** with **203 CloudTrail events** across **19 AWS services**.
...
# Or use Docker
docker pull ghcr.io/higakikeita/driftwire:v0.3.0
```
...
docker run -d \
  ...
  -v ~/.aws:/root/.aws:ro \
  ghcr.io/higakikeita/driftwire:v0.3.0 \
...
driftwire is open source and welcomes contributions!

### Ways to Contribute

1. **Report Issues** - [GitHub Issues](https://github.com/higakikeita/driftwire/issues)
2. **Request Features** - [GitHub Discussions](https://github.com/higakikeita/driftwire/discussions)
3. **Submit PRs** - See [CONTRIBUTING.md](https://github.com/higakikeita/driftwire/blob/main/CONTRIBUTING.md)
4. **Improve Documentation** - Help expand service guides
5. **Share Use Cases** - Tell us how you use driftwire
...
- **GitHub**: [github.com/higakikeita/driftwire](https://github.com/higakikeita/driftwire)
...
**driftwire v0.3.0** - Real-time Terraform Drift Detection Powered by Falco
