...
date: "2025-12-14"
excerpt: "driftwire v0.3.0 development adds comprehensive RDS support with 31 CloudTrail events covering DB instances, clusters, snapshots, parameter groups, subnet groups, and option groups. Now at 169 events (85% of target)."
author: "Keita Higaki"
...
We're excited to announce **comprehensive RDS (Relational Database Service) support** for driftwire! This update brings our CloudTrail event coverage from 164 to **169 events**, achieving **85% of our v0.3.0 target**.
