---
title: "Introducing ECS and EKS Support in driftwire"
date: "2025-12-12"
...
# Introducing ECS and EKS Support in driftwire

We're thrilled to announce that **driftwire v0.3.0-dev** now includes comprehensive support for **Amazon ECS (Elastic Container Service)** and **Amazon EKS (Elastic Kubernetes Service)**!
...
- [ECS Service Documentation](https://github.com/higakikeita/driftwire/blob/main/docs/services/ecs.md)
- [EKS Service Documentation](https://github.com/higakikeita/driftwire/blob/main/docs/services/eks.md)

## Feedback

We'd love to hear your feedback! Join the discussion on [GitHub](https://github.com/higakikeita/driftwire/discussions) or reach out on [X/Twitter](https://x.com/keitah0322).

---

*Built with ❤️ by the driftwire team*
