...
date: "2025-12-14"
excerpt: "driftwire v0.3.0 development continues with 49 new CloudTrail events across 4 major AWS services, bringing total coverage to 164 events (83% of target)."
author: "Keita Higaki"
...
We're excited to announce a **major expansion** of driftwire's drift detection capabilities! Today's update adds comprehensive support for **4 critical AWS services**, increasing our CloudTrail event coverage by **49 new events**.
...
- **[Lambda Service Guide](https://higakikeita.github.io/driftwire/services/lambda/)** — 600+ lines
- **[EC2 Service Guide](https://higakikeita.github.io/driftwire/services/ec2/)** — Complete compute coverage
- **[ElastiCache Service Guide](https://higakikeita.github.io/driftwire/services/elasticache/)** — Redis & Memcached
- **[Auto Scaling Service Guide](https://higakikeita.github.io/driftwire/services/autoscaling/)** — Dynamic scaling
...
- **Documentation**: [higakikeita.github.io/driftwire](https://higakikeita.github.io/driftwire/)
- **Issues**: [Report bugs or request features](https://github.com/higakikeita/driftwire/issues)
- **Discussions**: [Join the conversation](https://github.com/higakikeita/driftwire/discussions)
