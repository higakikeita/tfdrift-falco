...
async function getReleases(): Promise<Release[]> {
  const res = await fetch('https://api.github.com/repos/higakikeita/driftwire/releases', {
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-slate-300">
            Track the evolution of driftwire with our release history
          </p>
        </div>
      </div>
  ...
  return (
    <div className="bg-slate-900/50 border border-slate-700/50 rounded-xl p-6 hover:border-indigo-500/50 transition-all">
      ...
      <div className="flex items-center space-x-4">
        ...
        <a
          href={`https://github.com/higakikeita/driftwire/releases/download/${release.tag_name}/driftwire-linux-amd64`}
