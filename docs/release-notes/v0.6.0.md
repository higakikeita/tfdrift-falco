# Release Notes - v0.6.0 (Azure Full Support & Real-Time Enhancements)
...
## Major Release - Azure FullProvider & WebSocket v0.6.0
...
### WebSocket Real-Time Updates (v0.6.0)
...
- `pkg/api/websocket/handler.go` — v0.6.0 welcome message
