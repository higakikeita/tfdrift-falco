...
```bash
docker pull ghcr.io/higakikeita/driftwire:v0.13.0   # multi-arch (amd64/arm64)
```
...
[GitHub Release](https://github.com/higakikeita/driftwire/releases/tag/v0.13.0) / [CHANGELOG](https://github.com/higakikeita/driftwire/blob/main/CHANGELOG.md) / [Full diff v0.8.0...v0.13.0](https://github.com/higakikeita/driftwire/compare/v0.8.0...v0.13.0)
