...
The UI is developed using **Storybook-Driven Development (SDD)**, providing a 30x faster feedback loop compared to traditional full-stack development.
...
- **Mock data library** (`/ui/src/mocks/`) for backend-independent development
- **Visual documentation** - Stories serve as living component docs
- See [UI Development Guide](ui/README.md) for details
