...
A new experimental Grafana integration is being added to visualize drift events generated by tfdrift-falco.

The current preview includes:

- Loki + Promtail log indexing
- Sample drift event JSON
...
See [dashboards/grafana/README.md](dashboards/grafana/README.md) for more details.
