...
// EC2API defines the EC2 operations used by DiscoveryClient
...
// RDSAPI defines the RDS operations used by DiscoveryClient
type RDSAPI interface {
	DescribeDBInstances(ctx context.Context, params *rds.DescribeDBInstancesInput, optFns ...func(*rds.Options)) (*rds.DescribeDBInstancesOutput, error)
}

// EKSAPI defines the EKS operations used by DiscoveryClient
type EKSAPI interface {
	ListClusters(ctx context.Context, params *eks.ListClustersInput, optFns ...func(*eks.Options)) (*eks.ListClustersOutput, error)
	DescribeCluster(ctx context.Context, params *eks.DescribeClusterInput, optFns ...func(*eks.Options)) (*eks.DescribeClusterOutput, error)
}

// ElastiCacheAPI defines the ElastiCache operations used by DiscoveryClient
...
// ELBAPI defines the Elastic Load Balancing v2 operations used by DiscoveryClient
