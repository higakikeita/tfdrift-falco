...
var OtherServicesMappings = map[string]string{
	...
	"CreateFileSystem":       "aws_efs_file_system",
	"DeleteFileSystem":       "aws_efs_file_system",
	"UpdateFileSystem":       "aws_efs_file_system",
	"CreateMountTarget":      "aws_efs_mount_target",
	"DeleteMountTarget":      "aws_efs_mount_target",
	"CreateAccessPoint":      "aws_efs_access_point",
	"DeleteAccessPoint":      "aws_efs_access_point",
	"PutFileSystemPolicy":    "aws_efs_file_system_policy",
	"DeleteFileSystemPolicy": "aws_efs_file_system_policy",

	// Cognito - User Pools
	"CreateUserPool":       "aws_cognito_user_pool",
	"DeleteUserPool":       "aws_cognito_user_pool",
	"UpdateUserPool":       "aws_cognito_user_pool",
	"CreateUserPoolClient": "aws_cognito_user_pool_client",
	"DeleteUserPoolClient": "aws_cognito_user_pool_client",
	"UpdateUserPoolClient": "aws_cognito_user_pool_client",
	"CreateUserPoolDomain": "aws_cognito_user_pool_domain",
	"DeleteUserPoolDomain": "aws_cognito_user_pool_domain",
	"CreateIdentityPool":   "aws_cognito_identity_pool",
	"DeleteIdentityPool":   "aws_cognito_identity_pool",
	"UpdateIdentityPool":   "aws_cognito_identity_pool",
	"SetIdentityPoolRoles": "aws_cognito_identity_pool_roles_attachment",
	"CreateResourceServer": "aws_cognito_resource_server",
	"DeleteResourceServer": "aws_cognito_resource_server",
	"UpdateResourceServer": "aws_cognito_resource_server",

	// AppSync - GraphQL APIs
	"CreateGraphqlApi": "aws_appsync_graphql_api",
	"DeleteGraphqlApi": "aws_appsync_graphql_api",
	"UpdateGraphqlApi": "aws_appsync_graphql_api",
	"CreateResolver":   "aws_appsync_resolver",
	"DeleteResolver":   "aws_appsync_resolver",
	"UpdateResolver":   "aws_appsync_resolver",
	"CreateDataSource": "aws_appsync_datasource",
	"DeleteDataSource": "aws_appsync_datasource",
	"UpdateDataSource": "aws_appsync_datasource",
	// Note: CreateApiKey conflicts with API Gateway - handled in conflicts.go

	// MSK - Managed Streaming for Kafka
	"CreateCluster":              "aws_msk_cluster",
	"DeleteCluster":              "aws_msk_cluster",
	"UpdateClusterConfiguration": "aws_msk_cluster",
	"UpdateBrokerCount":          "aws_msk_cluster",
	"UpdateBrokerStorage":        "aws_msk_cluster",
	"UpdateBrokerType":           "aws_msk_cluster",
	"UpdateClusterKafkaVersion":  "aws_msk_cluster",
	"UpdateSecurity":             "aws_msk_cluster",
	"UpdateMonitoring":           "aws_msk_cluster",
	"CreateConfiguration":        "aws_msk_configuration",
	"DeleteConfiguration":        "aws_msk_configuration",

	// OpenSearch (Elasticsearch Service)
	"CreateDomain":       "aws_opensearch_domain",
	"DeleteDomain":       "aws_opensearch_domain",
	"UpdateDomainConfig": "aws_opensearch_domain",
	"AssociatePackage":   "aws_opensearch_domain",
	"DissociatePackage":  "aws_opensearch_domain",
	"CreateVpcEndpoint":  "aws_opensearch_vpc_endpoint",
	"DeleteVpcEndpoint":  "aws_opensearch_vpc_endpoint",
	"UpdateVpcEndpoint":  "aws_opensearch_vpc_endpoint",

	// CodePipeline
	"CreatePipeline":         "aws_codepipeline",
	"DeletePipeline":         "aws_codepipeline",
	"UpdatePipeline":         "aws_codepipeline",
	"StartPipelineExecution": "aws_codepipeline",
	"StopPipelineExecution":  "aws_codepipeline",
	"EnableStageTransition":  "aws_codepipeline",
	"DisableStageTransition": "aws_codepipeline",
	"PutWebhook":             "aws_codepipeline_webhook",
	"DeleteWebhook":          "aws_codepipeline_webhook",

	// CodeBuild
	"CreateProject":     "aws_codebuild_project",
	"DeleteProject":     "aws_codebuild_project",
	"UpdateProject":     "aws_codebuild_project",
	"CreateReportGroup": "aws_codebuild_report_group",
	"DeleteReportGroup": "aws_codebuild_report_group",
	"UpdateReportGroup": "aws_codebuild_report_group",
	// Note: CreateWebhook/DeleteWebhook/UpdateWebhook conflicts with CodePipeline - handled in conflicts.go

	// CodeDeploy
	// Note: CreateApplication/DeleteApplication conflicts with Kinesis Analytics - handled in conflicts.go
	"CreateDeploymentGroup":  "aws_codedeploy_deployment_group",
	"DeleteDeploymentGroup":  "aws_codedeploy_deployment_group",
	"UpdateDeploymentGroup":  "aws_codedeploy_deployment_group",
	"CreateDeploymentConfig": "aws_codedeploy_deployment_config",
	"DeleteDeploymentConfig": "aws_codedeploy_deployment_config",

	// Transfer Family (SFTP/FTP)
	"CreateServer": "aws_transfer_server",
	"DeleteServer": "aws_transfer_server",
	"UpdateServer": "aws_transfer_server",
	// Note: CreateUser/DeleteUser/UpdateUser conflicts with IAM - handled in conflicts.go

	// GuardDuty
	"CreateDetector":       "aws_guardduty_detector",
	"DeleteDetector":       "aws_guardduty_detector",
	"UpdateDetector":       "aws_guardduty_detector",
	"CreateFilter":         "aws_guardduty_filter",
	"DeleteFilter":         "aws_guardduty_filter",
	"UpdateFilter":         "aws_guardduty_filter",
	"CreateIPSet":          "aws_guardduty_ipset",
	"DeleteIPSet":          "aws_guardduty_ipset",
	"UpdateIPSet":          "aws_guardduty_ipset",
	"CreateThreatIntelSet": "aws_guardduty_threatintelset",
	"DeleteThreatIntelSet": "aws_guardduty_threatintelset",

	// AWS Config
	"PutConfigurationRecorder":    "aws_config_configuration_recorder",
	"DeleteConfigurationRecorder": "aws_config_configuration_recorder",
	"PutDeliveryChannel":          "aws_config_delivery_channel",
	"DeleteDeliveryChannel":       "aws_config_delivery_channel",
	"PutConfigRule":               "aws_config_config_rule",
	"DeleteConfigRule":            "aws_config_config_rule",
	"StartConfigurationRecorder":  "aws_config_configuration_recorder_status",
	"StopConfigurationRecorder":   "aws_config_configuration_recorder_status",
}
