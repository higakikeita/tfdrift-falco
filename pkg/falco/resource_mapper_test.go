...
func TestMapEventToResourceType(t *testing.T) {
	...
	tests := []struct {
		...
		// EventSource Disambiguation - Lambda vs KMS Aliases
		{"Lambda Alias Create", "CreateAlias", "lambda.amazonaws.com", "aws_lambda_alias"},
		{"Lambda Alias Delete", "DeleteAlias", "lambda.amazonaws.com", "aws_lambda_alias"},
		{"Lambda Alias Update", "UpdateAlias", "lambda.amazonaws.com", "aws_lambda_alias"},
		{"KMS Alias Create", "CreateAlias", "kms.amazonaws.com", "aws_kms_alias"},
		{"KMS Alias Delete", "DeleteAlias", "kms.amazonaws.com", "aws_kms_alias"},
		{"KMS Alias Update", "UpdateAlias", "kms.amazonaws.com", "aws_kms_alias"},

		// EventSource Disambiguation - EventBridge vs ALB Rules
		{"EventBridge Rule Delete", "DeleteRule", "events.amazonaws.com", "aws_cloudwatch_event_rule"},
		{"ALB Rule Delete", "DeleteRule", "elasticloadbalancing.amazonaws.com", "aws_lb_listener_rule"},

		// EventSource Disambiguation - Glue vs DynamoDB Tables
		{"Glue Table Create", "CreateTable", "glue.amazonaws.com", "aws_glue_catalog_table"},
		{"Glue Table Delete", "DeleteTable", "glue.amazonaws.com", "aws_glue_catalog_table"},
		{"Glue Table Update", "UpdateTable", "glue.amazonaws.com", "aws_glue_catalog_table"},
		{"DynamoDB Table Create", "CreateTable", "dynamodb.amazonaws.com", "aws_dynamodb_table"},
		{"DynamoDB Table Delete", "DeleteTable", "dynamodb.amazonaws.com", "aws_dynamodb_table"},
		{"DynamoDB Table Update", "UpdateTable", "dynamodb.amazonaws.com", "aws_dynamodb_table"},

		// EventSource Disambiguation - Glue Databases
		{"Glue Database Create", "CreateDatabase", "glue.amazonaws.com", "aws_glue_catalog_database"},
		{"Glue Database Delete", "DeleteDatabase", "glue.amazonaws.com", "aws_glue_catalog_database"},
		{"Glue Database Update", "UpdateDatabase", "glue.amazonaws.com", "aws_glue_catalog_database"},

		// EventSource Disambiguation - Step Functions Tags
		{"Step Functions Tag", "TagResource", "states.amazonaws.com", "aws_sfn_state_machine"},
		{"Step Functions Untag", "UntagResource", "states.amazonaws.com", "aws_sfn_state_machine"},
